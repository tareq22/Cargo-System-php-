...
if(isset($_POST['done'])){
	...
	$shipment = $_POST['shipment'];
 	...
 	$q="insert into shipping(name,location,destination,producttype,product,shipment)values('$name','$location','$destination','$producttype','$product','$shipment')";
...
<div class="form-group">
	...
	<input type="submit" name="done" value="Proceed"/>
	</div>
	<div class="form-group">
